// Load the data
d3.json("pie_status_counts.json").then(function(data) {
  ...
  const svg = d3.select("#pie-status-counts")
    .append("svg")
    .attr("width", width)
    .attr("height", height)
    .append("g")
  ...
  svg.selectAll('slices')
    ...
    .append('path')
    .attr('d', arc)
    .attr('fill', d => color(d.data.overall_status))
    .attr("stroke", "white")
  ...
  svg.append("text")
    ...
    .text("Distribution of Status for Vaccine Trials: 2005-2024");
